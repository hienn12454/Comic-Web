...
<html>
    ...
    <body>
        <div class="container mt-5">
            <a href="${pageContext.request.contextPath}/readStoryController?storyId=${chapter.storyId}" class="btn btn-info btn-sm" style="margin-bottom: 10px; background-color: #17b849">Back</a>
